      ...
      <div class="col">
        <div class="card">
          ...
          <div class="tab-content">
                        ...
                        <div class="row">
                          <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                <?php $bulan = $b['kode']; ?>
                                <?php $query1 = "SELECT * FROM landing_ref_eselon2"; ?>
                                <?php $kanwil = $this->db->query($query1)->result_array();
                                ?>
                                <?php $no = 1; ?>
                                <?php $j1 = 0; ?>
                                <?php $j2 = 0; ?>
                                ...
                                <?php foreach ($kanwil as $k) : ?>
                                  <tr>
                                    ...
                                    <td><?= $k['nama']; ?></td>
                                    <?php $eselon2_id = $k['id']; ?>
                                    <?php $query2 = "SELECT id,saldo_awal,permintaan,jumlah_pegawai,status_minta,date_created_minta FROM data_laporan_kanwil WHERE eselon2_id='$eselon2_id' AND bulan='$bulan'"; ?>
                                    ...
                                    <?php else : ?>
                                      <td>
                                        ...
                                        <a href="<?= base_url('monitoring-per-kanwil/delete/') . $r['id']; ?>" class="badge badge-danger" onclick="return confirm('Apakah Anda yakin akan mereset data ini?');" data-toggle="tooltip" data-placement="bottom" title="Reset"><i class="fa fa-trash"></i></a>
                                      </td>
                                    <?php endif; ?>
                                  </tr>
                                  <?php $j1 += $r['saldo_awal']; ?>
            ...
            <div class="active tab-pane" id="lpp">
              <div class="card-body">
                <ul class="nav nav-tabs justify-content-around" id="myTab" role="tablist">
                        ...
                        <div class="row">
                          <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                <?php $bulan = $b['kode'];
                                $query1 = "SELECT * FROM landing_ref_eselon2";
                                $kanwil = $this->db->query($query1)->result_array();
                                $no = 1;
                                $j1 = 0;
                                $j2 = 0;
                                $j3 = 0;
                                ...
                                <?php foreach ($kanwil as $k) : ?>
                                  <tr>
                                    ...
                                    <td><?= $k['nama']; ?></td>
                                    <?php $eselon2_id = $k['id']; ?>
                                    <?php $query2 = "SELECT id,saldo_awal,droping,pph_terutang,pph_disetor,pembayaran,saldo_akhir,status_lpp,date_created_lpp FROM data_laporan_kanwil WHERE eselon2_id='$eselon2_id' AND bulan='$bulan'"; ?>
                                    <?php $r = $this->db->query($query2)->row_array(); ?>
                                    <td class="text-right"><?= number_format($r['saldo_awal'], 0, ',', '.'); ?></td>
                                    ...
                                    <td>
                                      ...
                                      <?php $this->db->from('data_upload a'); ?>
                                      <?php $this->db->join('ref_dokumen b', 'a.dokumen_id=b.id', 'left'); ?>
                                      <?php $this->db->where(['a.laporan_id' => $r['id'], 'a.jns' => 4]); ?>
                                      <?php $upload = $this->db->get()->result_array(); ?>
                                      <ul class="mb-0 pl-4">
                                        <?php foreach ($upload as $u) : ?>
                                          <li><a href="<?= base_url('assets/files/') . $u['file']; ?>" target="_blank"><?= $u['nama']; ?></a></li>
                                    ...
                                    <?php else : ?>
                                      <td>
                                        ...
                                        <a href="<?= base_url('monitoring-per-kanwil/delete-lpp/') . $r['id']; ?>" class="badge badge-danger" onclick="return confirm('Apakah Anda yakin akan mereset data ini?');" data-toggle="tooltip" data-placement="bottom" title="Reset"><i class="fa fa-trash"></i></a>
                                      </td>
                                    <?php endif; ?>
                                  </tr>
                                  <?php
