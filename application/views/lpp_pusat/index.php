                    ...
                    <tr>
                      ...
                      <?php if ($r['status_lpp'] == 1) : ?>
                        <td>
                          ...
                          $this->db->where(['a.laporan_id' => $r['id'], 'a.jns' => 6]);
                      ...
                      <?php else : ?>
                        <td></td>
                        <td>
                          <a href="<?= base_url('lpp-pusat/edit/') . $r['id']; ?>" class="badge badge-success" data-toggle="tooltip" data-placement="bottom" title="Ubah"><i class="fa fa-edit"></i></a>
                          <a href="<?= base_url('lpp-pusat/kirim/') . $r['id']; ?>" class="badge badge-info" data-toggle="tooltip" data-placement="bottom" title="Kirim"><i class="fa fa-send"></i></a>
                        </td>
                      <?php endif; ?>
                    </tr>
                  <?php endforeach; ?>
