            ...
            <div class="row">
              <div class="col">
                <?php foreach ($tahun as $t) : ?>
                  <a href="<?= base_url('lpp-kanwil/index/') . $t['tahun']; ?>" class="btn btn-sm btn-outline-success <?= $t['tahun'] == $thn ? 'active' : '' ?> ml-1 mt-1 mb-1"><?= $t['tahun']; ?></a>
                <?php endforeach; ?>
              </div>
            </div>
            <div class="row mt-3">
                        ...
                        <tr>
                          ...
                          <?php if ($r['status_lpp'] == 1) : ?>
                            <td>
                              ...
                              $this->db->where(['a.laporan_id' => $r['id'], 'a.jns' => 4]);
                          ...
                          <?php else : ?>
                            <td></td>
                            <td>
                              <a href="<?= base_url('lpp-kanwil/edit/') . $r['id']; ?>" class="badge badge-success" data-toggle="tooltip" data-placement="bottom" title="Ubah"><i class="fa fa-edit"></i></a>
                              <a href="<?= base_url('lpp-kanwil/kirim/') . $r['id']; ?>" class="badge badge-info" data-toggle="tooltip" data-placement="bottom" title="Kirim"><i class="fa fa-send"></i></a>
                            </td>
                          <?php endif; ?>
                        </tr>
                      <?php endforeach; ?>
