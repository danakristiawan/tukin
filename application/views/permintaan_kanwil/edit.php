          ...
          <form action="" method="post" autocomplete="off">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="jumlah_pegawai" class="form-control <?= form_error('jumlah_pegawai') ? 'is-invalid' : '' ?>" value="<?= $laporan['jumlah_pegawai']; ?>">
              ...
              <div class="form-group">
                ...
                <input type="text" name="saldo_awal" class="form-control <?= form_error('saldo_awal') ? 'is-invalid' : '' ?>" value="<?= $laporan['saldo_awal']; ?>">
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="text" name="permintaan" class="form-control <?= form_error('permintaan') ? 'is-invalid' : '' ?>" value="<?= $laporan['permintaan']; ?>">
                <div class="invalid-feedback">
