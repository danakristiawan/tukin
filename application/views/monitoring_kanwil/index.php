    ...
    <div class="row">
      <div class="col">
        <?php foreach ($tahun as $t) : ?>
          <a href="<?= base_url('monitoring-kanwil/index/') . $t['tahun']; ?>" class="btn btn-sm btn-outline-success <?= $t['tahun'] == $thn ? 'active' : '' ?> ml-1 mt-1 mb-1"><?= $t['tahun']; ?></a>
        <?php endforeach; ?>
      </div>
    </div>
              ...
              <table class="table table-sm table-bordered">
                ...
                <tbody>
                  ...
                  foreach ($bulan as $b) : ?>
                    <tr>
                      <td><?= $b['nama']; ?></td>
                      <?php $r = $this->db->get_where('data_laporan_kanwil', ['eselon2_id' => $eselon2_id, 'bulan' => $b['kode'], 'tahun' => $thn])->row_array(); ?>
