            ...
            <div class="row">
              <div class="col">
                <?php foreach ($tahun as $t) : ?>
                  <a href="<?= base_url('lap-lpp/index/') . $t['tahun'] . '/' . $bln; ?>" class="btn btn-sm btn-outline-success <?= $t['tahun'] == $thn ? 'active' : '' ?> ml-1 mt-1 mb-1"><?= $t['tahun']; ?></a>
                <?php endforeach; ?>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <?php foreach ($bulan as $b) : ?>
                  <a href="<?= base_url('lap-lpp/index/') . $thn . '/' . $b['bulan']; ?>" class="btn btn-sm btn-outline-success <?= $b['bulan'] == $bln ? 'active' : '' ?> ml-1 mt-1 mb-1"><?= $b['bulan']; ?></a>
                <?php endforeach; ?>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  <?php foreach ($lpp as $r) : ?>
                    <tr>
                      ...
                      <td><i><?= $r['date_created_lpp'] == null ? '' : date('d-m-Y H:i:s', $r['date_created_lpp']); ?></i></td>
                    </tr>
                    <?php $j1 += $r['saldo_awal']; ?>
                    <?php $j2 += $r['droping']; ?>
