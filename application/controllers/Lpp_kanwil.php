...
class Lpp_kanwil extends CI_Controller
{
  ...
  public function index($thn = null)
  {
    ...
    $this->load->view('lpp_kanwil/index', $data);
  ...
  public function edit($id = null)
  {
    ...
    $this->load->view('template/sidebar', $data);
    $this->load->view('template/topbar', $data);
    $this->load->view('lpp_kanwil/edit', $data);
    $this->load->view('template/footer');
  }
  ...
  public function kirim($laporan_id = null)
  {
    ...
    $this->load->view('template/sidebar', $data);
    $this->load->view('template/topbar', $data);
    $this->load->view('lpp_kanwil/kirim', $data);
    $this->load->view('template/footer');
  }
  ...
  public function upload($laporan_id = null, $dokumen_id = null)
  {
      ...
      if ($validation->run()) {
        ...
        if ($upload_file) {
          ...
          if ($this->upload->do_upload('file')) {
            ...
            redirect('lpp-kanwil/upload/' . $laporan_id . '/' . $dokumen_id . '');
          }
        }
        //query
        $data = [
        ...
        redirect('lpp-kanwil/kirim/' . $laporan_id . '');
      }
    }
    // form
    $this->load->view('template/header');
    $this->load->view('template/sidebar', $data);
    $this->load->view('template/topbar', $data);
    $this->load->view('lpp_kanwil/upload', $data);
    $this->load->view('template/footer');
  }
